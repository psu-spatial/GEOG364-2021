...
Before we touch any data, it's important to start with words e.g. summarising what we already know about the data, the population under study and any context.
...
15. [ ] In the text below, briefly summarise the dataset. (imagine you are asked to summarise the abstract in class)<br>*Note,there is a spell check next to the knit button at the top of the script and press knit regularly to check it all looks good*.<br>For example you could summarise:
     + What is the topic under study?
     + What are the constraints of the data (e.g. it's an average, but over what time-period?)
     + Anything else that might be relevant to someone analysing the data
     + Given the topic, any confounding variables, or things we should be thinking about.
...
20. [ ]  In the text below the code chunk, use your knowledge from your reading, this lab script and the skim command output, to summarise the dataset for someone who has never seen it before (e.g. FULL SENTENCES), including:
    ...
    - A specification of the population being studied (as specific as possible)
    - A specification of the unit of observation
...
Now it's your turn!  The other file in your Lab 2 folder should be called NewYork.xlsx.  It contains real airbnb price data across New York City for 2021 from this source (http://insideairbnb.com/get-the-data.html - I did some quality control)

Use what you have learned to read the data into R, explore it and tell me what you find.  Hint, follow the same steps.  AKA
 ...
 - See what interesting stories you find
