...
```{r, Tut15Fig1, echo=FALSE, fig.align='center',out.width="50%"}
knitr::include_graphics('pg_Tut15_coding_fig1.png')
```
...
```{r, Tut15Fig2, echo=FALSE, fig.align='center',out.width="40%"}
knitr::include_graphics('pg_Tut15_coding_fig2.png')
```
<br> 
