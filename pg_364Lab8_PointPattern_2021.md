...
3. Use the code provided to work through [Tutorial 12](https://psu-spatial.github.io/Geog364-2021/pg_Tut2_startup.html#Tutorial_12).  Make sure all the libraries are installed, all the code chunks run, that it knits, and that there are no errors.  <br><br>
