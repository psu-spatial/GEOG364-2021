...
```{r, Tut13Fig1, echo=FALSE, fig.align='center',out.width="50%"}
knitr::include_graphics('pg_Tut13_coding_fig1.png')
```
...
```{r, Tut13Fig2, echo=FALSE, fig.align='center',out.width="40%"}
knitr::include_graphics('pg_Tut13_coding_fig2.png')
```
<br> 
