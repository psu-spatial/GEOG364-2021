...
$$
\operatorname{\widehat{per.income.gt75E}} = 0.06508 + 0.000006320(\operatorname{pop.densityE})
$$
...
$$
\operatorname{\widehat{per.income.gt75E}} = -0.02129 + 0.000008161(\operatorname{pop.densityE}) + 0.1896(\operatorname{per.owneroccupiedE})
$$
<br>
<br>
