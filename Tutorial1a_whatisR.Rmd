...
```{r, tut1afig1, echo=FALSE, fig.cap = "*The basic R console. You write in blue, the computer replies in black. The > means it is waiting for a command*"}
knitr::include_graphics('Tutorial1a_fig1_R.png')
```
...
```{r, tut1afig2, echo=FALSE, fig.cap = "*R-studio is much more sophisticated*"}
knitr::include_graphics('Tutorial1a_fig2_Rstudio.png')
```
