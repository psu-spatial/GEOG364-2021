...
29. A friend of mine is convinced that the firefly sightings are linked to temperatures and elevation.  Another friend is convinced that they are linked to light pollution and cities.<br>Change the base-maps in the interactive maps (there's a layer button) to explore and comment on this topic.
