...
```{r, include=FALSE}
toyIRPWW <- function(nrow=6,ncolumn=6, silent=FALSE){
  ...
  if(silent == FALSE){
    plot(IRP_raster, 
         main = list(paste("Number of same color (WW or GG) boundaries = ",ww_joincount),cex=.9))
    text(coordinates(IRP_raster), labels=IRP_raster[], cex=1.5)
  }
...
#make a histogram of all the white-white joins
hist(alloutput, br=40, main="The number of WHITE-WHITE joins for 2000 variations of an IRP")
