...
```{r, L5Fig8, echo=FALSE,out.width="20%"}
...
If I wanted to see if my ToyA matrix was simply usual to one compared to an IRP, here are my H0 and H1:
 ...
 - H~0~: *An Independent Random Process is causing the pattern in ToyA. <br> The number of Observed "white-white" joins (O~WW~) is no different than what you would expect from a pattern caused by an Independent Random Process (E~WW~):<br><br> O~WW~ = E~WW~*.
