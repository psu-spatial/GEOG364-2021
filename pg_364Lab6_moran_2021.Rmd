...
IF YOU DID'T LAST WEEK:  You can easily access US census data within R, but you need to sign up in advance for a password.
...
1. Run the command with the libraries. Now save everything  <br>

2. **IN THE CONSOLE**, type this command, but replace "YOUR API KEY GOES HERE" with the password you were given <br>
...
3. This wll now load the password.  
...
5. **Step 6:**<br>Use Tutorial 6Ec and  the tmap tutorial from Lab 4 to nake a professional plot of this 
...
## C: Social vulnerability and Moran's I
...
5. **Step 7:**<br>Your own spatial analysis
...
Your write up should include:
 ...
 - A Moran's hypothesis test with the results explained clearly in the text. 
...
-   You get 4/4 for something really impressives
